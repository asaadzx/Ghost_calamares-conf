...
template <> constexpr inline auto Config::qt_create_metaobjectdata<qt_meta_tag_ZN6ConfigE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(InstallChoice)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
        // Signal 'swapChoiceChanged'
        QtMocHelpers::SignalData<void(SwapChoice)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 2 },
        }}),
        ...
        // Slot 'setInstallChoice'
        QtMocHelpers::SlotData<void(InstallChoice)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
        // Slot 'setSwapChoice'
        ...
        // Slot 'setSwapChoice'
        QtMocHelpers::SlotData<void(SwapChoice)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 2 },
        }}),
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<InstallChoice>(13, 0x80000000 | 3, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet, 0),
        // property 'swapChoice'
        QtMocHelpers::PropertyData<SwapChoice>(14, 0x80000000 | 5, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet, 1),
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'InstallChoice'
        QtMocHelpers::EnumData<InstallChoice>(3, 3, QMC::EnumFlags{}).add({
        ...
        // enum 'SwapChoice'
        QtMocHelpers::EnumData<SwapChoice>(5, 5, QMC::EnumFlags{}).add({
        ...
        // enum 'LuksGeneration'
        QtMocHelpers::EnumData<LuksGeneration>(32, 32, QMC::EnumIsScoped).add({
