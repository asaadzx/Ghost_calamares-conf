...
template <> constexpr inline auto Config::qt_create_metaobjectdata<qt_meta_tag_ZN6ConfigE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(RestartMode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        ...
        // Slot 'restartNowMode'
        QtMocHelpers::SlotData<RestartMode() const>(10, 2, QMC::AccessPublic, 0x80000000 | 3),
        // Slot 'setRestartNowMode'
        QtMocHelpers::SlotData<void(RestartMode)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<RestartMode>(10, 0x80000000 | 3, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet, 0),
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'RestartMode'
        QtMocHelpers::EnumData<RestartMode>(3, 3, QMC::EnumIsScoped).add({
