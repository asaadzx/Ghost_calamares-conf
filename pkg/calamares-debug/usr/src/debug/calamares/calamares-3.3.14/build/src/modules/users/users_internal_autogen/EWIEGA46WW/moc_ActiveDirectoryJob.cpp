...
template <> constexpr inline auto ActiveDirectoryJob::qt_create_metaobjectdata<qt_meta_tag_ZN18ActiveDirectoryJobE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ActiveDirectoryJob, qt_meta_tag_ZN18ActiveDirectoryJobE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject ActiveDirectoryJob::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18ActiveDirectoryJobE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18ActiveDirectoryJobE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18ActiveDirectoryJobE_t>.metaTypes,
    nullptr
} };
...
void *ActiveDirectoryJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18ActiveDirectoryJobE_t>.strings))
