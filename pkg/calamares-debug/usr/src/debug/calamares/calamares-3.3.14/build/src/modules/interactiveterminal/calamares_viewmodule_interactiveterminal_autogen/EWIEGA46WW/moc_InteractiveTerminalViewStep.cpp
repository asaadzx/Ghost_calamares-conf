...
template <> constexpr inline auto InteractiveTerminalViewStep::qt_create_metaobjectdata<qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<InteractiveTerminalViewStep, qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject InteractiveTerminalViewStep::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>.metaTypes,
    nullptr
} };
...
void *InteractiveTerminalViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN27InteractiveTerminalViewStepE_t>.strings))
...
template <> constexpr inline auto InteractiveTerminalViewStepFactory::qt_create_metaobjectdata<qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
    ...
    return QtMocHelpers::metaObjectData<InteractiveTerminalViewStepFactory, qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject InteractiveTerminalViewStepFactory::staticMetaObject = { {
    QMetaObject::SuperData::link<CalamaresPluginFactory::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>.metaTypes,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN34InteractiveTerminalViewStepFactoryE_t>.strings))
        return static_cast<void*>(this);
