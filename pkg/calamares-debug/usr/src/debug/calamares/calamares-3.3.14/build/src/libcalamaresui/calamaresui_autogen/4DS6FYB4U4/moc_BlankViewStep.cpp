...
namespace {
struct qt_meta_tag_ZN9Calamares13BlankViewStepE_t {};
} // unnamed namespace

template <> constexpr inline auto Calamares::BlankViewStep::qt_create_metaobjectdata<qt_meta_tag_ZN9Calamares13BlankViewStepE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<BlankViewStep, qt_meta_tag_ZN9Calamares13BlankViewStepE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject Calamares::BlankViewStep::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Calamares13BlankViewStepE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Calamares13BlankViewStepE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9Calamares13BlankViewStepE_t>.metaTypes,
    nullptr
} };

void Calamares::BlankViewStep::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<BlankViewStep *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *Calamares::BlankViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9Calamares13BlankViewStepE_t>.strings))
