...
template <> constexpr inline auto TrackingStyleConfig::qt_create_metaobjectdata<qt_meta_tag_ZN19TrackingStyleConfigE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'tracking'
        QtMocHelpers::SlotData<TrackingState() const>(4, 2, QMC::AccessPublic, 0x80000000 | 5),
        // Slot 'isEnabled'
        ...
        // Slot 'setTracking'
        QtMocHelpers::SlotData<void(TrackingState)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 2 },
        }}),
        // Slot 'setTracking'
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<TrackingState>(10, 0x80000000 | 5, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::Final, 0),
        // property 'isEnabled'
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'TrackingState'
        QtMocHelpers::EnumData<TrackingState>(5, 5, QMC::EnumFlags{}).add({
