...
namespace {
struct qt_meta_tag_ZN23PartitionSizeControllerE_t {};
} // unnamed namespace

template <> constexpr inline auto PartitionSizeController::qt_create_metaobjectdata<qt_meta_tag_ZN23PartitionSizeControllerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PartitionSizeController, qt_meta_tag_ZN23PartitionSizeControllerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PartitionSizeController::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23PartitionSizeControllerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23PartitionSizeControllerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN23PartitionSizeControllerE_t>.metaTypes,
    nullptr
} };
...
void *PartitionSizeController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23PartitionSizeControllerE_t>.strings))
