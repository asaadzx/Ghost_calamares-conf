...
template <> constexpr inline auto PartitionLabelsView::qt_create_metaobjectdata<qt_meta_tag_ZN19PartitionLabelsViewE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PartitionLabelsView, qt_meta_tag_ZN19PartitionLabelsViewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject PartitionLabelsView::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19PartitionLabelsViewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19PartitionLabelsViewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19PartitionLabelsViewE_t>.metaTypes,
    nullptr
} };
...
void *PartitionLabelsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19PartitionLabelsViewE_t>.strings))
