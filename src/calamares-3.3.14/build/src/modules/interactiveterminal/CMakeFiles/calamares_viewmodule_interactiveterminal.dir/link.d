libcalamares_viewmodule_interactiveterminal.so: \
  ...
  /usr/lib/libKF6Parts.so.6.15.0 \
  ../../../libcalamaresui.so.3.3.14 \
  /usr/lib/libKF6XmlGui.so.6.15.0 \
  /usr/lib/libKF6ConfigWidgets.so.6.15.0 \
  /usr/lib/libKF6ColorScheme.so.6.15.0 \
  /usr/lib/libKF6GuiAddons.so.6.15.0 \
  /usr/lib/libKF6KIOCore.so.6.15.0 \
  /usr/lib/libKF6Service.so.6.15.0 \
  /usr/lib/libQt6Xml.so.6.9.1 \
  /usr/lib/libKF6WidgetsAddons.so.6.15.0 \
