...
template <> constexpr inline auto CountdownWaitingWidget::qt_create_metaobjectdata<qt_meta_tag_ZN22CountdownWaitingWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CountdownWaitingWidget, qt_meta_tag_ZN22CountdownWaitingWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject CountdownWaitingWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22CountdownWaitingWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22CountdownWaitingWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN22CountdownWaitingWidgetE_t>.metaTypes,
    nullptr
} };
...
void CountdownWaitingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CountdownWaitingWidget::*)()>(_a, &CountdownWaitingWidget::timeout, 0))
            return;
    }
}
...
void *CountdownWaitingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22CountdownWaitingWidgetE_t>.strings))
