...
template <> constexpr inline auto Calamares::Branding::qt_create_metaobjectdata<qt_meta_tag_ZN9Calamares8BrandingE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'string'
        QtMocHelpers::SlotData<QString(StringEntry) const>(1, 2, QMC::AccessPublic, QMetaType::QString, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'versionedName'
        ...
        // Slot 'styleString'
        QtMocHelpers::SlotData<QString(StyleEntry) const>(9, 2, QMC::AccessPublic, QMetaType::QString, {{
            { 0x80000000 | 10, 11 },
        }}),
        // Slot 'imagePath'
        QtMocHelpers::SlotData<QString(ImageEntry) const>(12, 2, QMC::AccessPublic, QMetaType::QString, {{
            { 0x80000000 | 13, 14 },
        }}),
        // Slot 'sidebarSide'
        QtMocHelpers::SlotData<PanelSide() const>(15, 2, QMC::AccessPublic, 0x80000000 | 16),
        // Slot 'navigationSide'
        QtMocHelpers::SlotData<PanelSide() const>(17, 2, QMC::AccessPublic, 0x80000000 | 16),
    };
    QtMocHelpers::UintData qt_properties {
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'StringEntry'
        QtMocHelpers::EnumData<StringEntry>(3, 3, QMC::EnumFlags{}).add({
        ...
        // enum 'ImageEntry'
        QtMocHelpers::EnumData<ImageEntry>(13, 13, QMC::EnumFlags{}).add({
        ...
        // enum 'StyleEntry'
        QtMocHelpers::EnumData<StyleEntry>(10, 10, QMC::EnumFlags{}).add({
        ...
        QtMocHelpers::EnumData<UploadServerType>(39, 39, QMC::EnumFlags{}).add({
            {   40, UploadServerType::None },
            {   41, UploadServerType::Fiche },
        }),
        // enum 'WindowExpansion'
        QtMocHelpers::EnumData<WindowExpansion>(42, 42, QMC::EnumIsScoped).add({
            {   43, WindowExpansion::Normal },
            {   44, WindowExpansion::Fullscreen },
            {   45, WindowExpansion::Fixed },
        }),
        // enum 'WindowDimensionUnit'
        QtMocHelpers::EnumData<WindowDimensionUnit>(46, 46, QMC::EnumIsScoped).add({
            {   40, WindowDimensionUnit::None },
            {   47, WindowDimensionUnit::Pixies },
            {   48, WindowDimensionUnit::Fonties },
        }),
        // enum 'WindowPlacement'
        QtMocHelpers::EnumData<WindowPlacement>(49, 49, QMC::EnumIsScoped).add({
            {   50, WindowPlacement::Center },
            {   51, WindowPlacement::Free },
        }),
        // enum 'PanelFlavor'
        QtMocHelpers::EnumData<PanelFlavor>(52, 52, QMC::EnumIsScoped).add({
            {   40, PanelFlavor::None },
            {   53, PanelFlavor::Widget },
            {   54, PanelFlavor::Qml },
        }),
        // enum 'PanelSide'
        QtMocHelpers::EnumData<PanelSide>(16, 16, QMC::EnumIsScoped).add({
            {   40, PanelSide::None },
            {   55, PanelSide::Left },
            {   56, PanelSide::Right },
            {   57, PanelSide::Top },
...
void Calamares::Branding::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { QString _r = _t->string((*reinterpret_cast< std::add_pointer_t<StringEntry>>(_a[1])));
        ...
        case 4: { QString _r = _t->shortVersionedName();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 5: { QString _r = _t->styleString((*reinterpret_cast< std::add_pointer_t<StyleEntry>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 6: { QString _r = _t->imagePath((*reinterpret_cast< std::add_pointer_t<ImageEntry>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
